...
function ContactUsPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    const serviceId = 'service_rv0mxjl'; // Directly assigning service ID
    const templateId = 'template_53r5ei4'; // Directly assigning template ID
    const userId = 'S4beYCMFcn3IDBv8U'; // Directly assigning user ID
